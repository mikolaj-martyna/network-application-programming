...
string checkMessageSyntax(const string &message) {
    ...
    if (parts[0] != "zad14odp" || parts[1] != "src" || parts[3] != "dst" || parts[5] != "data") {
        return "BAD_SYNTAX";
    }
    ...
    if (srcPort == 60788 && dstPort == 2901 && parts[6] == "hello :)") {
        return "TAK";
    }
...
int main() {
    ...
    cout << "Expected format: zad14odp;src;60788;dst;2901;data;hello :)" << endl;
