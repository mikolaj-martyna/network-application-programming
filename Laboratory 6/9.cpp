...
string getHTMLMessageBody() {
    cout << "Enter HTML message body (end with a line containing only '.'):" << endl;
    cout << "You can use HTML tags like <b>bold</b>, <i>italic</i>, <u>underline</u>, etc." << endl;
    string line;
    string body;
...
string getSampleHTMLMessage() {
    string exampleHTML = "<!DOCTYPE html>\n<html>\n<head>\n";
    exampleHTML += "<meta charset=\"UTF-8\">\n";
    exampleHTML += "<title>HTML Email Example</title>\n";
    exampleHTML += "</head>\n<body>\n";
    exampleHTML += "<h1 style=\"color: #0066cc;\">HTML Formatted Email</h1>\n";
    exampleHTML += "<p>This is a <b>bold text</b> example.</p>\n";
    exampleHTML += "<p>This is an <i>italic text</i> example.</p>\n";
    exampleHTML += "<p>This is an <u>underlined text</u> example.</p>\n";
    exampleHTML += "<p>You can also use <span style=\"color: red;\">colored text</span> and other styles.</p>\n";
    exampleHTML += "<ul>\n";
    exampleHTML += "  <li>List item 1</li>\n";
    exampleHTML += "  <li>List item 2</li>\n";
    exampleHTML += "  <li>List item 3</li>\n";
    exampleHTML += "</ul>\n";
    exampleHTML += "<p>Best regards,<br>HTML Email Sender</p>\n";
    exampleHTML += "</body>\n</html>";
...
int main() {
    ...
    cout << "Do you want to use a sample HTML message? (y/n): ";
    string useSample;
    getline(cin, useSample);

    string htmlBody;
    if (useSample == "y" || useSample == "Y") {
        htmlBody = getSampleHTMLMessage();
        cout << "Using sample HTML message." << endl;
    } else {
        htmlBody = getHTMLMessageBody();
    }
    ...
    cout << "HTML email sent successfully to " << recipients.size() << " recipient(s)!" << endl;
