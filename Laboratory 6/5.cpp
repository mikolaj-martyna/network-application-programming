...
int main() {
    ...
    const string subject = "Email with image attachment";
    const string body = "Email with image attachment";

    const string attachmentPath = "test.jpg";
    const string attachmentName = "test.jpg";
    ...
    cout << "Email with image attachment sent successfully!" << endl;
